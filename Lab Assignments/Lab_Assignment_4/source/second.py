#Implementing the text classification with LSTM model,with a new dataset which is not used in the class
#Importing libraries
...
#Loading dataset
tweets = pd.read_csv('C:\\Users\kamal\PycharmProjects\DeepLearning_Lab4\collection.csv', sep=',')
tweets.head(2)
